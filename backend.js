document.addEventListener('DOMContentLoaded', function () {
    ...
    let gateNumInput = parseInt(localStorage.getItem("gates"), 10);
    if (isNaN(gateNumInput)) gateNumInput = parseInt(gateElement.value, 10);
    let maxWallsInput = parseInt(localStorage.getItem("walls"), 10);
    if (isNaN(maxWallsInput)) maxWallsInput = parseInt(wallElement.value, 10);
    let bottlesInput = parseInt(localStorage.getItem("bottles"), 10);
    if (isNaN(bottlesInput)) bottlesInput = parseInt(bottleElement.value, 10);

    bottleElement.value = bottlesInput;
    gateElement.value = gateNumInput;
    wallElement.value = maxWallsInput;
    ...
    function save() {
        ...
        bottlesInput = parseInt(bottleElement.value);
        gateNumInput = parseInt(gateElement.value);
        maxWallsInput = parseInt(wallElement.value);
    }
